let config = {
	...
	containerColorBG: "#79553D",
	contentColorBG: "#8A6642",
	...
	imagesCoin: ["images/anton.jpg", "images/lesha.jpg", "images/masha.jpg", "images/sasha.jpg", "images/sla.jpg", "images/slam.jpg"],
...
function createPage() {
	...
	components.container.style.height = "96vh";
...
function createCursor () {
	...
	components.cursor.style.border = "4px solid green";
...
function createScore () {
	...
	components.score.style.color = "#000000";
...
function createGem ( t, l, row, col, img ) {
	...
	coin.style.backgroundSize = "96%";
	coin.style.backgroundRepeat = "no-repeat";
	coin.style.backgroundPosition = "center center"
...
function createGrid() {
	...
	for( i = 0; i < config.countRows; i++ ) {
		for( j = 0; j < config.countCols; j++ ) {
			...
			do{
				components.gems[i][j] = Math.floor(Math.random() * 6); //*************************
			} while( isStreak(i, j) );
...
function placeNewGems() {
	...
	for( i = 0; i < config.countCols; i++ ) {
		if( components.gems[ 0 ][ i ] == -1 ) {
			components.gems[ 0 ][ i ] = Math.floor( Math.random() * 6 );
